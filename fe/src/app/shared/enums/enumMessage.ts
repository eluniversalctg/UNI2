export enum MessagesTst {
  ...
  INSERTSUCCESS = 'Ingresado con éxito',
  ...
  SUCSSESMAIL = 'Se envió el correo.',
  ...
  SUCSSEPASSWORD = 'Contraseña modificada satisfactoriamente',
  ...
  NOOPERATOR = 'No se agregó ningún operador.',
  ...
  ERRORIMAGES = 'No se permite ingresar más imágenes',
  VARIABLEEXIST = 'Ya existe una condición con este, Id.',
  ...
  NOSITE = 'No ha seleccionado un sitio',
  ...
  Summary = 'Summary',
  Image = 'Image',
  EVENTNOVALUE = 'No se agregó ningún valor al tipo de evento.',
  ...
  VARIABLEERROR = 'No se pudo agregar debido a que la variable no es multi-valor o no acepta valores.',
